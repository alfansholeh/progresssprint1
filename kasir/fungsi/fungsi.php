...
function insert_transaksi()
{
	...
	if ($row) {
		...
		$query1 =  mysqli_query($koneksi, "INSERT INTO transaksi_temp SET kdproduk='$kdproduk', nm_produk='$nm_produk', kategori='$kategori', jumlah_beli=1, harga_satuan='$unit_price', total='$total'");
...
function update_transaksi_1()
{
	...
	// }else{
	// 	$query_2 = mysqli_query($koneksi, "UPDATE transaksi_temp SET jumlah_beli='$jumlah_beli', total='$total_baru' WHERE id='$id'");
	// }

	// update transaksi temp
	$query_1 = mysqli_query($koneksi, "UPDATE transaksi_temp SET jumlah_beli='$jumlah_beli', total='$total_baru' WHERE kdproduk='$kdproduk'");
	// update laporan penjualan
	$query_2 = mysqli_query($koneksi, "UPDATE laporan_penjualan SET jumlah_beli='$jumlah_beli', total='$total_baru' WHERE kdproduk='$kdproduk'");
