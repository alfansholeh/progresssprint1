...
function insert_produk()
{
	...
	return mysqli_query($koneksi, "INSERT INTO tb_produk SET nm_produk='$nm_produk', stok='$stok', harga='$harga', deskripsi='$deskripsi', gambar='$nama_file_baru'");
...
function update_produk()
{
	...
	return mysqli_query($koneksi, "UPDATE tb_produk SET  nm_produk='$nm_produk',  stok='$stok', harga='$harga', deskripsi='$deskripsi', gambar='$nama_file_baru' WHERE id='$id'");
}
